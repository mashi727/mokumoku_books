...
def get_data(ticker:str='AAPL',from_date:str='2023-01-01',to_date:str='2023-3-31',interval:str='1d') -> pd.DataFrame:
...
data = get_data(ticker='^GSPC',from_date='2023-01-01',to_date='2024-3-31')
